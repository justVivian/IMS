...
<p class="page-title">Edit Data Master Size</p>
@endsection

@section('content')
<div class="container">
    
    <form method="post" action="/size/update/{{ $size->id }}">
        ...
        <div class="form-group">
            <label>Size</label>
            <input type="text" name="size_satuan" class="form-control input-form" placeholder="Nama size .." value=" {{ $size->size_satuan }}">
